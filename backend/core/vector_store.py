...
# When omitted it defaults to the original constant, so CLI/original behavior
# is unchanged. The FastAPI layer passes a per-session collection name so that
# concurrent videos/meetings don't share retrieval context.
